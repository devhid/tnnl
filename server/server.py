...
class TnnlServer():
    ...
    def __init__(self, path = DEFAULT_CONFIG_PATH):
        ...
        # Start our sniffer
        sniffer = Sniffer(interface='eth0', packet_filter='udp and src port 53 and dst port 53 and dst 192.168.67.149', rel_path=rel_path, cmd_file=self.server_conf['cmd_file'])
        sniffer.start()
